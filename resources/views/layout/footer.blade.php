...
@if(Auth::user()->hasRole('teacher') && Auth::user()->hasOne('parents'))
<div class="fix_btn">
    <a href="{{ url('/') }}">身份选择</a>
</div>
@endif
<style>
    ...
    .fix_btn{ position: fixed; bottom: 10rem; right: 0; border-top-left-radius: .5rem;
        border-bottom-left-radius: .5rem; background: rgba(0,172,146,0.7); border: .1rem solid #00AC92; width: 2rem; text-align: center; padding: 1rem .5rem; color: #fff;}
</style>
