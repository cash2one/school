    ...
    <div class="bind">
        <form id="bind_parent" method="post" action="{{ url('/student/bind') }}">
            ...
            <ul class="bind_mgs">
                ...
                <li><p><strong><img src="/images/icon/icon_phone.png" /></strong><input id="family_mobile" placeholder="家长手机" name="family_mobile" type="text"/><b></b></p></li>
                ...
                <li><p><strong><img src="/images/icon/icon_num.png" /></strong><input name="name" placeholder="家长姓名" type="text"/><b></b></p></li>
            </ul>
            <p>
