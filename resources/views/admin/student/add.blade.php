...
@section('content')
    ...
    <h3 class="header-text">学生
        <span class="hed_te_span">
            <a href="student_list.html">管理</a>
            <a class="cursa" href="student_add.html">新增</a>
        </span>
    </h3>
    <!--当前位置 end-->
            ...
            <div class="smart-widget-body">
                <form class="form-horizontal no-margin form-border" method="post" action="{{ url('/admin/student/add') }}" id="basic-constraint" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control input-sm" name="student_name" >
                        </div><!-- /.col -->
                    </div><!-- /form-group -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <label style="position:relative; float:left; margin-right:20px;"><input  type="radio" name="sex" value="1" checked id="RadioGroup1_0">男</label>&nbsp;&nbsp;&nbsp;<label style="position:relative; float:left"><input type="radio" name="sex" value="2" id="RadioGroup1_1">女</label>
                        </div><!-- /.col -->
                    </div><!-- /form-group -->
